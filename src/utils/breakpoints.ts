...
export const mobile319 = 319;
export const mobile320 = 320;
...
export const mediaMaxMobile319 = `@media (max-width: ${mobile319}px)`;
export const mediaMinMobile320 = `@media (min-width: ${mobile320}px)`;
...
export const min640max767 = `@media (min-width: ${tablet640}px) and (max-width: ${tablet767}px)`;
